...
/*            Boolean signFlag = commonService.checkSign(userVo);
    ...
    private static void quickChoose() {
        ...
        for (int i = 0; i < a.length (); i++) {
            String[] xtemp = x;
            xtemp[ooneLocation] = a.charAt (i) + "";
            System.out.println (org.apache.commons.lang3.StringUtils.join (xtemp));
            onelist.add (org.apache.commons.lang3.StringUtils.join (xtemp));
        }
        //二字定，万 千 百
        int twoLocationX = 0;
        int twoLocationY = 4;
        for (int i = 0; i < a.length (); i++) {
            for (int j = 0; j < b.length (); j++) {
                String[] xtemp = x;
                xtemp[twoLocationX] = a.charAt (i) + "";
                xtemp[twoLocationY] = b.charAt (j) + "";
                System.out.println (org.apache.commons.lang3.StringUtils.join (xtemp));
                onelist.add (org.apache.commons.lang3.StringUtils.join (xtemp));
            }
        }
